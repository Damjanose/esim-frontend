...
export function SignInForm() {
  ...
  return (
    <div className="w-full max-w-[460px] rounded-[22px] border border-[#214867]/85 bg-[linear-gradient(150deg,#07182c,#050f1e)] p-7 shadow-[0_28px_70px_rgba(0,0,0,0.35)] sm:p-9">
